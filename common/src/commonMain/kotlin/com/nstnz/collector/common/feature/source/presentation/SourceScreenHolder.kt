...
import com.nstnz.collector.common.feature.core.di.sourceScope
...
internal fun SourceScreenHolder(
    ...
    OnLifecycleEvent(sourceScope) { event ->
        when (event) {
    ...
    SourceScreen(
        ...
        onAddCurrency = { viewModel.sendIntent(SourceScreenIntent.ShowAddCurrency) },
    )
}
